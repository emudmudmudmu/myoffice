...
class User extends \Quartet\Bundle\KakarotBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'lastLogin', 'locked', 'expired', 'expiresAt', 'confirmationToken', 'passwordRequestedAt', 'roles', 'credentialsExpired', 'credentialsExpireAt', 'id', 'name', 'created', 'updated', 'deleted', 'role', 'daySettings', 'cleanSchedules', 'likeSchedules', 'blogSchedules', 'division', 'position', 'parent', 'notifications', 'attendances', 'expenses', 'authors', 'approvers', 'subordinates');
    }
