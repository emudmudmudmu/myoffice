...
class __TwigTemplate_a753fc86ff82ee1e3888f19cb701d8f0c3539f79a7a244d632b12f5cf36e9c12 extends Twig_Template
{
    ...
    <table class=\"table table-striped\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["clean_schedules"]) ? $context["clean_schedules"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            // line 15
            echo "                    ";
            if (($this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "holiday") == 1)) {
                // line 16
                echo "                        <td class=\"clean_schedules_td danger\">
                    ";
            } elseif (($this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "login") == 1)) {
                // line 18
            ...
            // line 22
            echo "                            ";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "date"), "html", null, true);
            echo "(";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "dayname"), "html", null, true);
            echo ")
                        </td>
                ";
        }
    ...
    <table class=\"table table-striped\">
        ...
        // line 48
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["oneWeekHolidays"]) ? $context["oneWeekHolidays"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["day"]) {
            // line 49
            echo "                    <td class=\"like_schedules_td\">";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["day"]) ? $context["day"] : null), "dayname"), "html", null, true);
            echo "</td>
                ";
        }
        $_parent = $context['_parent'];
        ...
        // line 53
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["like_schedules"]) ? $context["like_schedules"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["groups"]) {
            ...
            echo "                <tr>
                    <td>
                        グループ";
            // line 56
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["groups"]) ? $context["groups"] : null), "groupname"), "html", null, true);
            echo "
                    </td>
                ";
            // line 58
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["groups"]) ? $context["groups"] : null), "group"));
            foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
                // line 59
                echo "                    ";
                if (($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "login") == 1)) {
                    // line 60
    ...
    <table class=\"table table-striped\">
        ...
        // line 76
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["oneWeekHeader"]) ? $context["oneWeekHeader"] : null));
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["day"]) {
            ...
            if (($this->getAttribute((isset($context["loop"]) ? $context["loop"] : null), "index") == 6)) {
                ...
                echo "                        <td class=\"blog_schedules_header_td danger\">
                    ";
            } elseif (($this->getAttribute((isset($context["loop"]) ? $context["loop"] : null), "index") == 7)) {
                // line 80
                echo "                        <td class=\"blog_schedules_header_td danger\">
                    ";
            } else {
            ...
            // line 84
            echo "                            ";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["day"]) ? $context["day"] : null), "name"), "html", null, true);
            echo "</td>
                ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
        ...
        // line 87
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["blog_schedules"]) ? $context["blog_schedules"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["days"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
                ...
                if (($this->getAttribute((isset($context["loop"]) ? $context["loop"] : null), "index") == 6)) {
                    ...
                    echo "                            <td class=\"blog_schedules_td danger\">
                        ";
                } elseif (($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "holiday") == 1)) {
                    // line 95
                    echo "                            <td class=\"blog_schedules_td danger\">
                        ";
                } elseif (($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "login") == 1)) {
                    // line 97
                ...
                // line 101
                echo "                                ";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "date"), "html", null, true);
                echo "<br>";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "username"), "html", null, true);
                echo "</td>
                    ";
