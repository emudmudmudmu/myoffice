 ...
 */
class Expense extends \Quartet\Bundle\KakarotBundle\Entity\Expense implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setClearingDate($clearingDate);
    }

    public function getClearingDate()
    {
        $this->__load();
        return parent::getClearingDate();
    }
    ...
    {
        $this->__load();
        return parent::setAccountTitle($accountTitle);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'date', 'payee', 'amount', 'note', 'clearingDate', 'status', 'created', 'updated', 'deleted', 'user', 'accountTitle');
    }
