 ...
 */
class Position extends \Quartet\Bundle\KakarotBundle\Entity\Position implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'created', 'updated', 'deleted', 'users');
    }
