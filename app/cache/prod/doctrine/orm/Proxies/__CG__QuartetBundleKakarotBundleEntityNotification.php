 ...
 */
class Notification extends \Quartet\Bundle\KakarotBundle\Entity\Notification implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'content', 'isRead', 'created', 'updated', 'user');
    }
