...
use Quartet\Bundle\KakarotBundle\Form\UserType;
use Quartet\Bundle\KakarotBundle\Form\DaySettingsType;
...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('QuartetKakarotBundle:User')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('QuartetKakarotBundle:User')->find($id);
    ...
    */
    ...
    {
        $form = $this->createForm('quartet_bundle_kakarotbundle_user', $entity, array(
     ...
     * @Method("PUT")
     * @Template("QuartetKakarotBundle:User:edit.html.twig")
     */
