...
use Quartet\Bundle\KakarotBundle\Entity\Position;
use Quartet\Bundle\KakarotBundle\Form\PositionType;
...
class PositionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('QuartetKakarotBundle:Position')->findAll();
     ...
     * @Method("POST")
     * @Template("QuartetKakarotBundle:Position:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('QuartetKakarotBundle:Position')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("QuartetKakarotBundle:Position:edit.html.twig")
     */
